...
<div>
        ...
        <table border={0} cellSpacing={2} cellPadding={0}>
          <tbody><tr>
              <th valign="TOP" align="LEFT"><p align="LEFT">Field</p></th>
              <th valign="TOP" align="LEFT"><p align="LEFT">Name</p></th>
              <th valign="TOP" align="LEFT"><p align="LEFT">Status</p></th>
              <th valign="TOP" align="LEFT"><p align="LEFT">Explanation</p></th>
            </tr>
            <tr>
              <th valign="TOP">0</th>
            ...
            <tr>
              ...
              <td valign="TOP" bgcolor="#c0c0c0"><a href="ReadMe-3.0.0d3.html#Canonical Combining Classes">Canonical combining classes</a></td>
              <td valign="TOP" bgcolor="#c0c0c0">normative</td>
        ...
        <h3><a name="General Category" />General Category</h3>
        ...
        <h3><a name="Bidirectional Category" />Bidirectional Category</h3>
        ...
        <h3><a name="Character Decomposition" />Character Decomposition</h3>
        ...
        <h3><a name="Canonical Combining Classes" />Canonical Combining Classes</h3>
        <table border={0} cellSpacing={2} cellPadding={0}>
          <tbody><tr>
        ...
        <h3><a name="Decompositions and Normalization" />Decompositions and Normalization</h3>
        ...
        <h3><a name="Case Mappings" />Case Mappings</h3>
        ...
        <h2><a name="Property Invariants" />Property Invariants</h2>
